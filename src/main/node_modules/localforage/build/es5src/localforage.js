(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define('localforage', ['module', 'exports', 'localforage/build/es5src/drivers/indexeddb', 'localforage/build/es5src/drivers/websql', 'localforage/build/es5src/drivers/localstorage', './utils/serializer', './utils/promise', './utils/executeCallback', './utils/executeTwoCallbacks', './utils/includes', './utils/isArray'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, exports, require('localforage/build/es5src/drivers/indexeddb'), require('localforage/build/es5src/drivers/websql'), require('localforage/build/es5src/drivers/localstorage'), require('localforage/build/es5src/utils/serializer'), require('./utils/promise'), require('./utils/executeCallback'), require('./utils/executeTwoCallbacks'), require('./utils/includes'), require('./utils/isArray'));
    } else {
        var mod = {
            exports: {}
        };
