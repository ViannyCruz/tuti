(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define('webSQLStorage', ['module', 'exports', '../utils/isWebSQLValid', 'localforage/build/es5src/utils/serializer', '../utils/promise', '../utils/executeCallback', '../utils/normalizeKey', '../utils/getCallback'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, exports, require('../utils/isWebSQLValid'), require('localforage/build/es5src/utils/serializer'), require('../utils/promise'), require('../utils/executeCallback'), require('../utils/normalizeKey'), require('../utils/getCallback'));
    } else {
        var mod = {
            exports: {}
        };
